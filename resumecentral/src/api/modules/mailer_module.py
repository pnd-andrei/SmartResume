...
class Mailer:
    def __init__(self):
        ...
        self.__server = smtplib.SMTP_SSL("smtp.gmail.com", self.__port, context=self.__context)
...
def send_verification_mail(mail, temporary_url):
    mail_agent = Mailer()
    mail_agent.send_email(mail, "Verification mail - ResumeCentral", f"http://localhost:8000/validate/{temporary_url}")
